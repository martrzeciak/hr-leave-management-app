...
namespace HRLeaveManagement.Persistence.Migrations
{
    ...
    [Migration("20240608185335_InitialMigration")]
            ...
            modelBuilder.Entity("HRLeaveManagement.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2024, 6, 8, 18, 53, 35, 310, DateTimeKind.Utc).AddTicks(658),
                            DateModified = new DateTime(2024, 6, 8, 18, 53, 35, 310, DateTimeKind.Utc).AddTicks(661),
                            DefaultDays = 10,
                            Name = "Vacation"
                        });
                });
